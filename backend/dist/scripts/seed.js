...
const seedData = async () => {
    ...
    try {
        ...
        await Organization_1.default.collection.deleteMany({});
        await User_1.default.collection.deleteMany({});
        await Case_1.default.collection.deleteMany({});
        await CaseInput_1.default.collection.deleteMany({});
        await CaseStatement_1.default.collection.deleteMany({});
        await Prediction_1.default.collection.deleteMany({});
        await TimelineEvent_1.default.collection.deleteMany({});
        // Create users
        const salt = await bcryptjs_1.default.genSalt(10);
        const passwordHash = await bcryptjs_1.default.hash('password123', salt);
        // Create a shared Default Org
        const newOrgs = await Organization_1.default.create([{ name: 'Default Org' }]);
        ...
        const sampleCase1 = await Case_1.default.create({
            organizationId: orgId,
        ...
        const sampleCase2 = await Case_1.default.create({
            organizationId: orgId,
        ...
        const sampleCase3 = await Case_1.default.create({
            organizationId: orgId,
